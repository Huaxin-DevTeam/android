...
public class RegisterActivity extends BaseActivity {
	...
	OnClickListener registerClick = new OnClickListener() {
		...
		public void onClick(View v) {
			...
			if(ph.compareTo("")==0 || em.compareTo("")==0 || pw.compareTo("")==0 || pw2.compareTo("")==0){
				Utils.makeError(RegisterActivity.this, getResources().getString(R.string.all_fields_required));
				return;
			}
			
			//Check pwd...
			if(pw.compareTo(pw2) != 0){
				Utils.makeError(RegisterActivity.this, getResources().getString(R.string.pwd_not_match));
				return;
			}
			...
			Intent intent =  new Intent(RegisterActivity.this,WebService.class);
			intent.putExtra(WebService.PARAM_OPERATION, WebService.OPERATION_REGISTER);
