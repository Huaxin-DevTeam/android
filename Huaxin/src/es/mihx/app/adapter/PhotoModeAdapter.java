...
import es.mihx.app.activity.ListActivity;
...
public class PhotoModeAdapter extends ModeAdapter {
	...
	public PhotoModeAdapter(Context context, ItemList items, ListView listView) {
		this.items = items;
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if(convertView == null){
			convertView = inflater.inflate(R.layout.listitem_photomode, parent, false);
		...
		if(Utils.isFavorite(item.getId())) {
	        holder.fav.setBackgroundResource(R.drawable.ic_star_white_on);
	        mHighlightedPositions[position] = true;
	    }else {
	        holder.fav.setBackgroundResource(R.drawable.ic_star_white_off);
		...
		holder.fav.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
			    ...
			    if(mHighlightedPositions[position]) {
			        button.setBackgroundResource(R.drawable.ic_star_white_off);
			        mHighlightedPositions[position] = false;
			    }else {
			        button.setBackgroundResource(R.drawable.ic_star_white_on);
			        mHighlightedPositions[position] = true;
			    }
